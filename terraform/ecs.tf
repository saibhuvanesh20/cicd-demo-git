...
name = "${var.app_name}-alb-sg"; vpc_id = aws_vpc.main.id
ingress { from_port=80; to_port=80; protocol="tcp"; cidr_blocks=["0.0.0.0/0"] }
egress { from_port=0; to_port=0; protocol="-1"; cidr_blocks=["0.0.0.0/0"] }
}
resource "aws_security_group" "ecs_tasks" {
name = "${var.app_name}-ecs-sg"; vpc_id = aws_vpc.main.id
ingress { from_port=var.container_port; to_port=var.container_port
...
health_check {
path = "/health"; healthy_threshold=2; unhealthy_threshold=3
